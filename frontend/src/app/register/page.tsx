    ...
    <main className="flex min-h-screen items-center justify-center bg-fond px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="border border-petrole-200 bg-white p-6">
          <h1 className="mb-6 font-display text-xl font-bold text-petrole-800">Créer un compte propriétaire</h1>
          ...
          <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-petrole-500">Téléphone (optionnel)</label>
          <input
            value={phone}
